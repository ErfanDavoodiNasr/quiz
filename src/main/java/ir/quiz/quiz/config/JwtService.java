...
public class JwtService {
    ...
    private static final String SECRET_KEY = "76a143bda362a8a3eaa6c875a2e3358b5b2453e35247bf002e536e774518bfb4";
    ...
    public String generateJwtToken(Map<String, Object> claims, UserDetails userDetails) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + (24 * 60 * 60 * 1_000)))
